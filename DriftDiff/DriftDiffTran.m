...
% Simulation = 'GaussianTwoCarRCLinDoping';
Simulation = 'GaussianTwoCarRCExpDoping';
...
elseif strcmp(Simulation,'GaussianTwoCarRCLinDoping')
    eval('SetGaussian2CarParasLinearDoping');
elseif strcmp(Simulation,'GaussianTwoCarRCExpDoping')
    eval('SetGaussian2CarParasExpDoping');
end
